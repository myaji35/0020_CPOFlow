...
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name cpoflow cpoflow
...
# Install base packages + Node.js for Playwright (SAP Ariba PDF scraping)
