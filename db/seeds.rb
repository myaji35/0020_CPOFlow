...
[
  { title: "Sika Waterproofing - Barakah Nuclear Plant Phase 3",
    ...
    status: :new_rfq, priority: :urgent, due_date: 7.days.from_now,
  ...
  { title: "GTX-A Tunnel Sealant - 광명역 구간",
    ...
    status: :make_quo, priority: :high, due_date: 14.days.from_now,
  ...
  { title: "Cheongpyeong Dam Waterproofing Repair",
    ...
    status: :pending_po, priority: :high, due_date: 21.days.from_now,
  ...
  { title: "Abu Dhabi Metro Extension - Concrete Admixtures",
    ...
    status: :new_po, priority: :medium, due_date: 30.days.from_now,
  ...
  { title: "Sika Grout - Shin-Hanul NPP Unit 3&4",
    ...
    status: :delivery_items, priority: :urgent, due_date: 5.days.from_now,
  ...
  { title: "Dubai Creek Tower - Structural Adhesive",
    ...
    status: :problem, priority: :high, due_date: 3.days.from_now,
  ...
  { title: "Yeongwol PSP - Membrane Waterproofing",
    ...
    status: :get_grn, priority: :medium, due_date: 60.days.ago,
