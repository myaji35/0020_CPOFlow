...
|------|------|------|------|-------------|------|
| 대시보드 | 95% | **95%** | — | — | ✅ |
| 받은편지함 | 90% | **95%** | +5 | API fallback UX+RFQ 판정 아이콘 | ✅ W3-A |
| 칸반 | 85% | **95%** | +10 | 칼럼 카운트 즉시 반영+보드 설명 | ✅ W3-A |
| 발주 목록 | 80% | **95%** | +15 | KPI 카드+PDF 로고/합계+보드별 폼 | ✅ W3-B |
| 일정 | 75% | **90%** | +15 | 주간 뷰+오늘 강조+상태 색상+드로어 | ✅ W1-D |
| 팀 | 80% | **95%** | +15 | KPI 6종+성과 chart+담당자 분포 | ✅ W2-A |
| 발주처 | 85% | **95%** | +10 | KPI 4종+리스크 등급 설명+배지 SLDS | ✅ W3-B |
| 거래처 | 85% | **95%** | +10 | KPI 4종+eCount 동기화 배지 | ✅ W3-B |
| 외부 담당자 | 80% | **95%** | +15 | KPI+소속 필터+이메일 이력+서명 개선 | ✅ W2-B |
| 현장 | 80% | **95%** | +15 | KPI+예산 카드+검색+활성 필터 | ✅ W2-C |
| 직원 관리 | 85% | **95%** | +10 | 만료 경고 배지+KPI 명확화 | ✅ W3-C |
| 조직도 | 75% | **95%** | +20 | 트리+접기/펼치기+검색+빈 부서 표시 | ✅ W1-C+W3-C |
| 경영 리포트 | 70% | **95%** | +25 | PDF+보드 필터+차트 인터랙션+CSV 아이콘 | ✅ W1-B+W3-C |
| eCount | 60% | **90%** | +30 | 거래내역 실질 뷰+빈 상태+동기화 배지 | ✅ W1-A+W3-C |
| 설정 | 85% | **95%** | +10 | 요약 배지+보드CRUD+블럭+카드상태 | ✅ W3-C |
| 공통 | 80% | **90%** | +10 | 검색 빈 상태+알림 상대 시간 | ✅ W2-D |
| **전체 평균** | **81%** | **94%** | **+13** | **Wave 1+2+3 완료. 목표 95% 달성** | ✅ |
